...
RUN openssl req -newkey rsa:4096 -x509 -sha256 -days 365 -nodes -out /etc/nginx/ssl/coolwebsite.crt -keyout /etc/nginx/ssl/coolwebsite.key -subj "/C=FR/ST=Paris/L=Paris/O=42Paris/OU=alhumea/CN=coolwebsite"
